...
The frequency range is split into several windows (continuous) and high resolution scanning is done inside each window to eventually find narrow resonance peaks of high quality factors.
...
for i in range(len(Frequency)-1):
	...
	start_freq = Frequency [i]
	stop_freq = Frequency [i+1]
