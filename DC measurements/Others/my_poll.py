...
def R_measure(device_id, amplitude, out_channel, in_channel, time_constant, frequency, poll_length, device, daq, out_mixer_channel, bias_resistor, in_range, out_range, offset =0):
    ...
    exp_setting = [['/%s/sigins/%d/ac'             % (device, in_channel), 0],
                   ...
                   ['/%s/sigouts/%d/offset/'       % (device, out_channel), offset]]
