...
ramp_speed = 10 # the safe speed for ramping the current voltage [mA/s]
target_B = 200e-3 #[mT] 
current_points = 200
...
if I_max > 2:
	print('Maximum current exceeds 2A; Terminating the program ...')
	sys.exit()
...
I_bias_list = np.linspace(0, target_B*B_I_conversion, current_points)
