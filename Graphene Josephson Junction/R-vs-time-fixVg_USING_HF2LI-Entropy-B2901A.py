...
The program measures the resistance of the sample at fixed time intervals (set by delta_t).
...
delta_t = 60 # measurement every 60s
...
while (not END):
	...
	# plt.subplot(2, 1, 1)
	plt.plot(TIME/60,RESISTANCE, '--b',marker='.',markersize = 1.5, linewidth=0.5, alpha=0.9)
